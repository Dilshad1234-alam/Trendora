      ...
      <div className="mx-auto max-w-4xl rounded-3xl bg-white p-6 shadow-xl sm:p-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input required type="text" placeholder="e.g. Summer sale on gym memberships" className="w-full rounded-xl border p-3 outline-none focus:border-violet-500" value={formData.topic} onChange={(e) => setFormData({...formData, topic: e.target.value})} />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select className="w-full rounded-xl border p-3 outline-none focus:border-violet-500" value={formData.objective} onChange={(e) => setFormData({...formData, objective: e.target.value})}>
            ...
            <div>
              ...
              <select className="w-full rounded-xl border p-3 outline-none focus:border-violet-500" value={formData.cta} onChange={(e) => setFormData({...formData, cta: e.target.value})}>
          ...
          <div>
            ...
            <input type="text" placeholder="e.g. 20% off for first 50 customers" className="w-full rounded-xl border p-3 outline-none focus:border-violet-500" value={formData.offer} onChange={(e) => setFormData({...formData, offer: e.target.value})} />
          </div>
