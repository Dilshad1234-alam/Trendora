      ...
      <div className="mx-auto max-w-4xl rounded-3xl bg-white p-6 shadow-xl sm:p-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input required type="text" placeholder="e.g. New cafe opening in Mumbai" className="w-full rounded-xl border p-3 outline-none focus:border-violet-500" value={formData.topic} onChange={(e) => setFormData({...formData, topic: e.target.value})} />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex items-center gap-3 pt-6">
              <input type="checkbox" className="h-5 w-5 accent-violet-700" checked={formData.emoji} onChange={(e) => setFormData({...formData, emoji: e.target.checked})} />
