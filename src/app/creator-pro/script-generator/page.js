...
import { generateScript } from "@/services/ai-pro.api";
import { saveContent } from "@/services/saved.api";

export default function ProScriptGeneratorPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setMessage({ type: "success", text: "Pro Script generated successfully." });
    } catch (error) {
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm font-bold uppercase tracking-[0.2em] text-violet-600">
            Pro AI Script Generator
          </p>

          <h1 className="mt-2 text-3xl font-black leading-tight tracking-tight text-zinc-950 sm:text-4xl">
            Create a Ready-to-Record <span className="bg-gradient-to-r from-violet-600 via-indigo-600 to-red-600 bg-clip-text text-transparent">Script</span>
          </h1>
